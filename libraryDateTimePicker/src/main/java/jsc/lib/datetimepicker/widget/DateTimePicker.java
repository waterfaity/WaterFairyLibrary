...
public class DateTimePicker {
    ...
    public interface ResultHandler {
        void handle(DateTimePicker dateTimePicker, Date date);
    }
    ...
    public int MAX_MINUTE = 59;
    public int MAX_HOUR = 23;
    ...
    public DateTimePicker(Context context, ResultHandler resultHandler, Date startDate, Date endDate, Builder builder) {
        ...
        if (startDate == null) startDate = new Date(1990 - 1900, 0, 1);
        startCalendar.setTime(startDate);
        if (endDate == null) endDate = new Date(2100 - 1900, 0, 1);
    ...
    private void initView() {
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                handler.handle(DateTimePicker.this, selectedCalender.getTime());
                datePickerDialog.dismiss();
            }
        });
    }
    ...
    private void updateView(Builder builder) {
        ...
        showHour(builder.showHour);
        showMinus(builder.showMinus);

        yearPicker.setIsLoop(builder.yearLoop);
        monthPicker.setIsLoop(builder.yearLoop);
        dayPicker.setIsLoop(builder.yearLoop);
        hourPicker.setIsLoop(builder.yearLoop);
        minutePicker.setIsLoop(builder.yearLoop);
    }
     ...
     * @param showYear
     */
    private void showYear(boolean showYear) {
        disScrollUnit();
        if (showYear) {
     ...
     * @param showMonth
     */
    private void showMonth(boolean showMonth) {
        disScrollUnit();
        if (showMonth) {
     ...
     * @param showDay
     */
    private void showDay(boolean showDay) {
        disScrollUnit();
        if (showDay) {
     ...
     * @param showHour
     */
    private void showHour(boolean showHour) {
        disScrollUnit();
        if (showHour) {
     ...
     * @param showMinus
     */
    private void showMinus(boolean showMinus) {
        disScrollUnit();
        if (showMinus) {
    ...
    public static class Builder {
        ...
        private CharSequence hour;
        private CharSequence minute;

        private int titleTextColor;
        private int cancelTextColor;
        private int okTextColor;
        private int yearLabelTextColor;
        private int monthLabelTextColor;
        private int dayLabelTextColor;
        private int hourLabelTextColor;
        private int minuteLabelTextColor;
        private int textColor;
        private int selectedTextColor;
        private int headerBackgroundColor;
        private int bodyBackgroundColor;
        private int segmentingLineColor;
        private int segmentingLineHeight;
        ...
        private boolean yearLoop;
        private boolean monthLoop;
        private boolean dayLoop;
        private boolean hourLoop;
        private boolean minusLoop;


        public boolean isYearLoop() {
            return yearLoop;
        }

        public Builder setYearLoop(boolean yearLoop) {
            this.yearLoop = yearLoop;
            return this;
        }

        public boolean isMonthLoop() {
            return monthLoop;
        }

        public Builder setMonthLoop(boolean monthLoop) {
            this.monthLoop = monthLoop;
            return this;
        }
        ...
        public Builder setDayLoop(boolean dayLoop) {
            this.dayLoop = dayLoop;
            return this;
        }

        public boolean isHourLoop() {
            return hourLoop;
        }

        public Builder setHourLoop(boolean hourLoop) {
            this.hourLoop = hourLoop;
            return this;
        }

        public boolean isMinusLoop() {
            return minusLoop;
        }

        public Builder setMinusLoop(boolean minusLoop) {
            this.minusLoop = minusLoop;
            return this;
        }
        ...
        public Builder setShowMinus(boolean showMinus) {
